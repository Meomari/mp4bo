...
class ProductAction extends GlobalAction
{
    ...
    public function detail(){
       parent::_checkID();
        $commentCount = M('Comment')->where("title_id={$this->id} and module='Product'")->count();
        $this->assign('commentCount', $commentCount);
        parent::getJoinDetail(array("a.id={$this->id}", "id={$this->id}"), 'view_count', C('DB_PREFIX').'product a', C('DB_PREFIX').'category b on a.category_id=b.id','a.*, b.title as categoryName');
    }//静态浏览内容页面
