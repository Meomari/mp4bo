 ...
 * @version        	$Id: VideoAction.class.php v2.0 2010-01-01 06:59:03 

 */

class VideoAction extends GlobalAction
{
    ...
    public function index()
    {
        ...
        $dataList = $this->dao->Table(C('DB_PREFIX').'video a')->Join(C('DB_PREFIX').'category b on a.category_id=b.id')->Field('a.*,b.title as category')->Order($setOrder)->Where($condition)->Limit($p->firstRow.','.$p->listRows)->select();
