 ...
 * @version        	$Id: VdAction.class.php v2.0 2010-01-01 06:59:03 
...
class VdAction extends GlobalAction
{
    ...
    public function index()
    {
        ...
        $dataList = $this->dao->Table(C('DB_PREFIX').'vd a')->Join(C('DB_PREFIX').'category b on a.category_id=b.id')->Field('a.*,b.title as category')->Order($setOrder)->Where($condition)->Limit($p->firstRow.','.$p->listRows)->select();
    ...
    {   global $rr;
        parent::_checkPermission('Vd_insert');
    ...
    {
        parent::_checkPermission('Vd_modify');
        parent::_setMethod('post');
    ...
    public function doCommand()
    {
        ...
        parent::_checkPermission('Vd_command');
        if(getMethod() == 'get'){
